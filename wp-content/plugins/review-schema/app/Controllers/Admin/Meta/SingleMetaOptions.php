...
class SingleMetaOptions {
	...
	public function mosque_schema_fields() {
		...
		$schema_fields = [
			...
			'holderClass' => 'rtrs-hidden rtrs-schema-field',
			'label'       => esc_html__( 'Mosque schema', 'review-schema-pro' ),
			'fields'      => [
				[
					'id'     => 'mosque',
					'type'   => 'auto-fill',
	...
	public function church_schema_fields() {
		...
		$schema_fields = [
			...
			'holderClass' => 'rtrs-hidden rtrs-schema-field',
			'label'       => esc_html__( 'Church schema', 'review-schema-pro' ),
			'fields'      => [
				[
					'id'     => 'church',
					'type'   => 'auto-fill',
	...
	public function hindutemple_schema_fields() {
		...
		$schema_fields = [
			...
			'holderClass' => 'rtrs-hidden rtrs-schema-field',
			'label'       => esc_html__( 'Hindu temple schema', 'review-schema-pro' ),
			'fields'      => [
				[
					'id'     => 'hindutemple',
					'type'   => 'auto-fill',
	...
	public function buddhisttemple_schema_fields() {
		...
		$schema_fields = [
			...
			'holderClass' => 'rtrs-hidden rtrs-schema-field',
			'label'       => esc_html__( 'Buddhist temple schema', 'review-schema-pro' ),
			'fields'      => [
				[
					'id'     => 'buddhisttemple',
					'type'   => 'auto-fill',
