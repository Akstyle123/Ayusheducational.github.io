...
class Functions {
	...
	public static function rich_snippet_cats() {
		...
		return apply_filters('rtrs_rich_snippet_cats', [
			...
			'mosque'  			   => esc_html__('Mosque', 'review-schema-pro'),
			'church'  			   => esc_html__('Church', 'review-schema-pro'),
			'hindutemple'  		   => esc_html__('Hindu Temple', 'review-schema-pro'),
			'buddhisttemple'  		   => esc_html__('Buddhist Temple', 'review-schema-pro')
		]);
	}
